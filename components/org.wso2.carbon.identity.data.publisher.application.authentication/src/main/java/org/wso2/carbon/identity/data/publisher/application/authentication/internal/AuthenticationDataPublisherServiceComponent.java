...
import org.wso2.carbon.identity.data.publisher.application.authentication.impl.TenantDASLoginDataPublisher;
...
public class AuthenticationDataPublisherServiceComponent {
    ...
    protected void activate(ComponentContext context) {
        ...
        bundleContext
                .registerService(AuthenticationDataPublisher.class.getName(), new TenantDASLoginDataPublisher(), null);
        bundleContext
